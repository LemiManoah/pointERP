...
export type PurchaseOrderReceiptOptions = {
    canViewCosts: boolean;
    purchaseOrders: PurchaseOrder[];
    selectedPurchaseOrderId: string;
};

type Props = PurchaseOrderReceiptOptions;
...
export function PurchaseOrderReceiptForm(props: PurchaseOrderReceiptOptions) {
                ...
                <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    >
                        <SearchableSelect
                            ...
                            options={props.purchaseOrders.map((order) => ({
                                value: order.id,
                ...
                <CardContent>
                    {!purchaseOrder ? (
                        <div className="flex min-h-40 flex-col items-center justify-center gap-2 text-center text-muted-foreground">
                            ...
                            <p>
                                Select an approved purchase order to inspect its
                                outstanding items.
                            </p>
                        </div>
                    ) : (
                    ...
                    <div className="flex justify-end">
                        <Button
                            ...
                            disabled={
                                form.processing ||
                                !purchaseOrder ||
                                !form.data.lines.some((line) => line.receive)
                            }
                        >
                            Record receipt
                        </Button>
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
                ...
                <PurchaseOrderReceiptForm {...props} />
            </div>
        </AppLayout>
    );
}
