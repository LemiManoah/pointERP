...
import { CalendarDialog, type CalendarRow } from './partials/calendar-dialog';
...
export default function ReportingCalendarsIndex({
    ...
    function deactivate(calendar: CalendarRow) {
        confirm({
                    ...
                    <div className="grid gap-4">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-muted-foreground">
                                Define when each site owes a daily report and
                                when missed reporting escalates.
                            </p>
                        </div>
                                        ...
                                        >
                                            ...
                                            <td className="py-3 pr-4">
                                                <Badge variant="secondary">
                                                    {
                                                        calendar.missing_escalation_days
                                                    }{' '}
                                                    consecutive misses
                                                </Badge>
                                            </td>
                        ...
                        {filteredCalendars.length === 0 && (
                            <div className="grid place-items-center gap-2 py-12 text-center">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    {tab === 'active'
                                        ? 'Create a tenant, project or site reporting calendar.'
                                        : 'Deactivated calendars appear here.'}
                                </p>
                            </div>
                        )}
                    </CardContent>
