...
use App\Http\Controllers\Operations\InventoryBatchController;
...
Route::middleware(['auth', 'verified'])->group(function (): void {
    ...
    Route::post('inventory/items/{inventoryItem}/batches', [InventoryBatchController::class, 'store'])->name('inventory.items.batches.store');
    Route::put('inventory/items/{inventoryItem}/batches/{inventoryBatch}', [InventoryBatchController::class, 'update'])->name('inventory.items.batches.update');
    ...
    Route::post('inventory/stores/{inventoryStore}/items/{inventoryItem}/movements', [InventoryStockMovementController::class, 'store'])->name('inventory.stock-movements.store');
