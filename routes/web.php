...
Route::middleware(['auth', 'verified'])->group(function (): void {
    ...
    Route::get('inventory/stock-counts', [InventoryStockCountController::class, 'index'])->name('inventory.stock-counts.index');
    Route::post('inventory/stock-counts', [InventoryStockCountController::class, 'store'])->name('inventory.stock-counts.store');
