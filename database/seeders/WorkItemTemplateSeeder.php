...
final class WorkItemTemplateSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($tenants as $tenant) {
            resolve(\App\Services\TenantContext::class)->set($tenant);
            ...
            $defaultUnitId = $m3?->id ?? UnitOfMeasure::query()->where('is_active', true)->value('id');
            if (! $defaultUnitId) {
                continue;
            }
            ...
            $templates = [
                [
                    ...
                    'unit_of_measure_id' => $m3?->id ?? $defaultUnitId,
                ...
                [
                    ...
                    'unit_of_measure_id' => $m?->id ?? $defaultUnitId,
                ...
                [
                    ...
                    'unit_of_measure_id' => $m2?->id ?? $defaultUnitId,
