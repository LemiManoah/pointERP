...
final class RolePermissionSeeder extends Seeder
{
    ...
    private array $roles = [
        'Director' => [
            ...
            'work-item-templates.manage',
            'work-item-templates.view',
    ...
    public function run(): void
    {
        $fullExpenseAccess = [
            ...
            'expenses.approve', 'expenses.cancel', 'expenses.change-branch', 'expenses.create', 'expenses.delete-drafts', 'expenses.export',
        ...
        foreach (['Director', 'Administrator'] as $role) {
            $this->roles[$role] = [...$this->roles[$role], ...$fullExpenseAccess,
                ...
                'pos.record-payment', 'pos.sell-on-credit', 'pos.view', 'pos.view-all-sales', 'pos.view-payments',
            ];
        }
