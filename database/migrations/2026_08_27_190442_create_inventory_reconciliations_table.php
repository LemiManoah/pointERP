...
return new class extends Migration
{
    ...
    {
        Schema::create('inventory_reconciliations', function (Blueprint $table): void {
            ...
            $table->unique(['tenant_id', 'reference'], 'inv_reconcile_ref_uq');
            $table->unique(['tenant_id', 'request_key'], 'inv_reconcile_request_uq');
            $table->index(['tenant_id', 'branch_id', 'status'], 'inv_reconcile_scope_idx');
        });
    }
