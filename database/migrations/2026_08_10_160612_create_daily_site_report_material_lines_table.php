...
return new class extends Migration
{
    ...
    {
        Schema::create('daily_site_report_material_lines', function (Blueprint $table): void {
            ...
            $table->index(['tenant_id', 'daily_site_report_id'], 'dsr_material_tenant_report_index');
    ...
    {
        Schema::dropIfExists('daily_site_report_material_lines');
    }
};
