...
final class StoreCountryRequest extends FormRequest
{
    ...
    {
        return [
            'code' => ['required', 'string', 'alpha', 'size:2', Rule::unique((new Country)->getTable(), 'code')],
            'name' => ['required', 'string', 'max:120'],
            'iso3_code' => ['required', 'string', 'alpha', 'size:3', Rule::unique((new Country)->getTable(), 'iso3_code')],
