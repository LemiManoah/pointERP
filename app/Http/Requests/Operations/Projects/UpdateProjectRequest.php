...
final class UpdateProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'reference' => ['required', 'string', 'max:80', Rule::unique((new Project)->getTable(), 'reference')->where('tenant_id', $tenantId)->ignore($project instanceof Project ? $project->id : null)],
