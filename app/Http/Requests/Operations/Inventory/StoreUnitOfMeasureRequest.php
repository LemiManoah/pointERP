...
final class StoreUnitOfMeasureRequest extends FormRequest
{
    ...
    {
        return [
            'code' => ['required', 'string', 'max:30', Rule::unique('unit_of_measures', 'code')->where('tenant_id', resolve(\App\Services\TenantContext::class)->id())->ignore($this->route('unitOfMeasure')?->id)],
