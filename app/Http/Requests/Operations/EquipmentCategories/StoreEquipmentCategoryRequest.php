...
final class StoreEquipmentCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'code' => ['required', 'string', 'max:40', Rule::unique((new EquipmentCategory)->getTable(), 'code')->where('tenant_id', $tenantId)],
            'name' => ['required', 'string', 'max:120', Rule::unique((new EquipmentCategory)->getTable(), 'name')->where('tenant_id', $tenantId)],
