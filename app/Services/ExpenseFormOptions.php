...
final readonly class ExpenseFormOptions
{
    ...
    private function unitName(ExpenseItem $item): ?string
    {
        $unit = $item->getRelation('defaultUnit');

        return $unit instanceof UnitOfMeasure ? ($unit->symbol ?? $unit->name) : null;
    }
}
