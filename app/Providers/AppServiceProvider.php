...
use App\Policies\InventoryDirectReceiptPolicy;
...
use App\Policies\ProjectEstimatePolicy;
...
final class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(InventoryDirectReceipt::class, InventoryDirectReceiptPolicy::class);
        ...
        Gate::policy(ExpenseItem::class, ExpenseItemPolicy::class);
        Gate::policy(ExpensePayment::class, ExpensePaymentPolicy::class);
        Gate::policy(Project::class, ProjectPolicy::class);
        Gate::policy(ProjectEstimate::class, ProjectEstimatePolicy::class);
